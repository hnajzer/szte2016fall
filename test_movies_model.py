...
class MoviesModelTest(unittest.TestCase):
    def setUp(self):
        self.a_movie_data = {"title": "Trainspotting", "year": 1995, "director": "Danny Boyle"}
        self.other_movie_data = {"title": "Interstellar", "year": 2014, "director": "Christopher Nolan"}
    ...
    def test_get_movie_existing(self):
        movie_id = self.movie_model.create_movie(self.a_movie_data)
        result = self.movie_model.get_movie(movie_id)
